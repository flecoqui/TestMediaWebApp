class Music extends MediaObject {
    CreateOldView() {
        ...
        if (!isNullOrUndefined(this.GetContentUrl())) {
            ...
            result += "</div>";
            result += "<div class=\"btn-group\">";
            result += "<button type=\"button\" id=\"" + this.GetLoopButtonId() + "\"  class=\"mediabutton\"><strong>" + GetCurrentString("Repeat") + "</strong></button>";
            result += "<button type=\"button\" id=\"" + this.GetNoLoopButtonId() + "\"  class=\"mediabutton\"><strong>" + GetCurrentString("Unrepeat") + "</strong></button>";
            result += "</div>";
        }
        if (!isNullOrUndefined(this.GetContentUrl())) {
            result += "<div>";
